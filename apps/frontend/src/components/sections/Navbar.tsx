  ...
  return (
    <nav ref={navRef} className="w-full fixed top-0 z-20 px-6 py-3 text-white">
      <div className="w-full flex items-center justify-between">
        <Link href="/">
          <div className="text-2xl lg:text-3xl font-semibold">AuraSense</div>
        </Link>
        {/* Desktop View */}
        <div className="hidden md:flex flex-1 gap-8 mx-3 justify-center items-center">
          ...
          <Link href="/analyze" className="text-lg hover:underline">
            Analyze
          </Link>
        </div>
      ...
      {isNavbarOpen && (
        <div className="md:hidden flex flex-col items-center py-3 mt-3">
          ...
          <Link href="/analyze" className="mb-1 text-lg" onClick={toggleNavbar}>
            Analyze
          </Link>
          {user ? (
            <>
